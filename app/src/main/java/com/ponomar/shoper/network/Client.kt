...
class Client @Inject constructor(
    ...
    suspend fun verifyCode(code:Int,phone:String):ApiResponse<TokenResponse>{
        val body = CodeBody(code,phone,"null")
        return authService.sendUserCodeToVerifyWhenUserTryToLogin(body)
    }
